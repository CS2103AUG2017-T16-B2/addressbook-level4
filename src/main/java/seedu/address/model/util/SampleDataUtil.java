        ...
        try {
            return new Person[] {
                new Person(new Name("Alex Yeoh"), new Phone("student/97272031 parent/97979797 "),
                    ...
                    new Address("Blk 30 Geylang Street 29, #06-40"), new FormClass("6E1"), new PostalCode("123456"),
                        new Remark("I am a man"),getTagSet("friends")),
                new Person(new Name("Bernice Yu"), new Phone("student/97272031 parent/97979797 "),
                        new Email("berniceyu@example.com"),
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new FormClass("6E1"),
                    new PostalCode("654321"), new Remark("Woman"), getTagSet("colleagues", "friends")),
                ...
                new Person(new Name("David Li"), new Phone("student/97272031 parent/97979797 "),
                    ...
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new FormClass("12S23"),
                        new PostalCode("676767"), new Remark("Git Gud"), getTagSet("family")),
                ...
                new Person(new Name("Roy Balakrishnan"), new Phone("student/97272031 parent/97979797 "),
                    ...
                    new Address("Blk 45 Aljunied Street 85, #11-31"), new FormClass("12s23"), new PostalCode("999666"),
