...
:repoURL: https://github.com/CS2103AUG2017-T16-B2/tree/master

By: `CS2103AUG2017 T16-B2`      Since: `SEP 2017`      Licence: `MIT`

== Introduction

Welcome to 'cherBook, the address book for Teachers. This address book application manages and displays students' academic grades with relevant statistics. +
Some features of this address book includes:

****
* Displaying information of any student for easy reference.
* Statistical graph generated based on the grades of each student.
****
...
This section guides you on how to setup a suitable developer environment on intelliJ for developing cherBook.

=== Prerequisites

Your computer needs to be set up with:
