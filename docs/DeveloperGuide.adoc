...
This developer guide provides future maintainers the necessary information to obtain a high level understanding
of the source code and be able to contribute to the repository. The relevant information include cherBook's software architecture, components, documentation, API and contributing guidelines.

== Setting up

This section guides you how to set up and configure your working environment for cherBook in *IntelliJ* IDE.

=== Prerequisites

Your computer needs to have the following installed:
